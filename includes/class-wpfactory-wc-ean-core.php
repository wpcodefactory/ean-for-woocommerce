...
if ( ! class_exists( 'WPFactory_WC_EAN_Core' ) ) :

class WPFactory_WC_EAN_Core {
	...
	function __construct() {
		...
		if ( 'yes' === get_option( 'alg_wc_ean_plugin_enabled', 'yes' ) ) {
			$this->edit                   = require_once plugin_dir_path( __FILE__ ) . 'class-wpfactory-wc-ean-edit.php';
			$this->admin                  = require_once plugin_dir_path( __FILE__ ) . 'class-wpfactory-wc-ean-admin.php';
			$this->search                 = require_once plugin_dir_path( __FILE__ ) . 'class-wpfactory-wc-ean-search.php';
			$this->display                = require_once plugin_dir_path( __FILE__ ) . 'class-wpfactory-wc-ean-display.php';
			$this->order_items_table      = require_once plugin_dir_path( __FILE__ ) . 'class-wpfactory-wc-ean-order-items-table.php';
			$this->import_export          = require_once plugin_dir_path( __FILE__ ) . 'class-wpfactory-wc-ean-export-import.php';
			$this->orders                 = require_once plugin_dir_path( __FILE__ ) . 'class-wpfactory-wc-ean-orders.php';
			$this->rest_api               = require_once plugin_dir_path( __FILE__ ) . 'class-wpfactory-wc-ean-rest-api.php';
			$this->product_tools          = require_once plugin_dir_path( __FILE__ ) . 'class-wpfactory-wc-ean-product-tools.php';
			$this->order_tools            = require_once plugin_dir_path( __FILE__ ) . 'class-wpfactory-wc-ean-order-tools.php';
			$this->settings_import_export = require_once plugin_dir_path( __FILE__ ) . 'class-wpfactory-wc-ean-manage-settings.php';
			$this->compatibility          = require_once plugin_dir_path( __FILE__ ) . 'class-wpfactory-wc-ean-compatibility.php';
			$this->shortcodes             = require_once plugin_dir_path( __FILE__ ) . 'class-wpfactory-wc-ean-shortcodes.php';
			$this->product_block_editor   = require_once plugin_dir_path( __FILE__ ) . 'class-wpfactory-wc-ean-product-block-editor.php';
		}
	 ...
	 * @since   1.2.0
	 *
	 * @todo    (dev) move to `WPFactory_WC_EAN_Orders`?
	 */
...
return new WPFactory_WC_EAN_Core();
