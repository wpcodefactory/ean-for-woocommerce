...
if ( ! class_exists( 'WPFactory_WC_EAN_Settings_Tools' ) ) :

class WPFactory_WC_EAN_Settings_Tools extends WPFactory_WC_EAN_Settings_Section {
...
return new WPFactory_WC_EAN_Settings_Tools();
