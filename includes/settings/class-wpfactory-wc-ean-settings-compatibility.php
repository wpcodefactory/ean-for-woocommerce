...
if ( ! class_exists( 'WPFactory_WC_EAN_Settings_Compatibility' ) ) :

class WPFactory_WC_EAN_Settings_Compatibility extends WPFactory_WC_EAN_Settings_Section {
	...
	function get_settings() {
		return array(
			...
			array(
				...
				'desc_tip' => (
					sprintf(
						...
						__( 'This will add EAN to the product data of the %s plugin.', 'ean-for-woocommerce' ),
						'<a target="_blank" href="' . 'https://wordpress.org/plugins/google-listings-and-ads/' . '">' .
							__( 'Google Listings & Ads', 'ean-for-woocommerce' ) .
						'</a>'
					) . '<br>' .
					sprintf(
						/* Translators: %s: Key name. */
						__( 'After enabling the checkbox, go to "Marketing > Google Listings & Ads > Attributes > Create attribute rule", select the "GTIN" attribute, and then select %s in the "Use value from existing product field" dropdown box.', 'ean-for-woocommerce' ),
						'<code>' . wpfactory_wc_ean()->core->ean_key . '</code>'
					) . '<br>' .
					(
						defined( 'WC_GLA_VERSION' ) ?
						sprintf(
							/* Translators: %s: Page link. */
							__( 'You may also want to "Sync All Products with Google Merchant Center" on the %s.', 'ean-for-woocommerce' ),
							'<a href="' . admin_url( 'admin.php?page=connection-test-admin-page' ) . '">' .
								__( 'Google Listings & Ads connection testing page', 'ean-for-woocommerce' ) .
							'</a>'
						) :
						''
					)
			...
			array(
				...
				'desc'     => __( 'Enable', 'ean-for-woocommerce' ),
				'desc_tip' => sprintf(
					/* Translators: %1$s: Plugin link, %2$s: Settings path. */
					__( 'This will add EAN to the %1$s plugin settings in "%2$s".', 'ean-for-woocommerce' ),
					'<a target="_blank" href="' . 'https://woocommerce.com/products/google-product-feed/' . '">' .
						__( 'Google Product Feed', 'ean-for-woocommerce' ) .
					'</a>',
			...
			array(
				...
				'desc_tip' => (
					sprintf(
						/* Translators: %s: Plugin link. */
						__( 'This will add EAN to the product search of the %s plugin.', 'ean-for-woocommerce' ),
						'<a target="_blank" href="' . 'https://woocommerce.com/products/point-of-sale-for-woocommerce/' . '">' .
							__( 'Point of Sale for WooCommerce', 'ean-for-woocommerce' ) .
						'</a>'
					) . '<br>' .
					__( '<strong>Please note</strong> that "WPFactory > EAN > General > Search" option must be enabled as well.', 'ean-for-woocommerce' ) . '<br>' .
					__( '<strong>Alternatively</strong> you can add "EAN" to the "Scanning Fields" (in "WooCommerce > Settings > Point of Sale > Scanning") and "Product SKU" to the "Search Includes" (in "WooCommerce > Settings > Point of Sale > Register") options.', 'ean-for-woocommerce' ) . '<br>' .
					'* ' . __( 'To enable searching with a scanner, add "EAN" field to the "Scanning Fields" option (in "WooCommerce > Settings > Point of Sale > Scanning").', 'ean-for-woocommerce' )
				),
			...
			array(
				...
				'desc_tip' => sprintf(
					...
					'<a target="_blank" href="' . 'https://codecanyon.net/item/openpos-a-complete-pos-plugins-for-woocomerce/22613341' . '">' .
						__( 'Woocommerce OpenPos', 'ean-for-woocommerce' ) .
					'</a>',
			...
			array(
				...
				'desc_tip' => sprintf(
					/* Translators: %s: Plugin link. */
					__( 'This will show EAN in PDF documents of the %s plugin.', 'ean-for-woocommerce' ),
			...
			array(
				...
				'desc_tip' => sprintf(
					...
					__( 'Available placeholder: %s.', 'ean-for-woocommerce' ),
					'%ean%'
				),
			...
			array(
				'desc'     => (
					...
					sprintf(
						...
						'<code>' .
							implode( ',', array( 'invoice', 'packinglist', 'deliverynote', 'dispatchlabel' ) ) .
						'</code>'
					)
				),
			...
			array(
				...
				'desc_tip' => sprintf(
					/* Translators: %s: Plugin link. */
					__( 'This will show EAN in vendor product form of the %s plugin.', 'ean-for-woocommerce' ),
			...
			array(
				'desc'     => sprintf(
					/* Translators: %s: Example. */
					__( 'Required HTML, e.g.: %s', 'ean-for-woocommerce' ),
					'<code>' .
						esc_html( '&amp;nbsp;<abbr class="required" title="' . esc_attr__( 'required', 'woocommerce' ) . '">*</abbr>' ) . // phpcs:ignore WordPress.WP.I18n.TextDomainMismatch
					'</code>'
				),
			...
			array(
				'desc'     => (
					__( 'Description', 'ean-for-woocommerce' ) . '<br>' .
					sprintf(
						/* Translators: %s: Example. */
						__( 'You can use HTML and shortcodes here, e.g.: %s', 'ean-for-woocommerce' ),
						'<code>' .
							esc_html( '<div>[alg_wc_ean_is_valid] | [alg_wc_ean_is_unique]</div>' ) .
						'</code>'
					)
				),
			...
			array(
				...
				'desc_tip' => sprintf(
					/* Translators: %1$s: Plugin link, %2$s: Plugin link. */
					__( 'This will show EAN in product forms of the %1$s and %2$s plugins.', 'ean-for-woocommerce' ),
					'<a target="_blank" href="https://wordpress.org/plugins/wc-frontend-manager/">' .
						__( 'WCFM', 'ean-for-woocommerce' ) .
					'</a>',
					'<a target="_blank" href="https://wordpress.org/plugins/wc-multivendor-marketplace/">' .
						__( 'WCFM Marketplace', 'ean-for-woocommerce' ) .
					'</a>'
				),
				'desc'     => __( 'Enable', 'ean-for-woocommerce' ),
				'id'       => 'alg_wc_ean_wcfm',
			...
			array(
				...
				'desc_tip' => sprintf(
					/* Translators: %s: Title. */
					__( 'This will add "Generate %s" button to the vendor product edit pages.', 'ean-for-woocommerce' ),
			...
			array(
				...
				'desc_tip' => sprintf(
					/* Translators: %s: Plugin link. */
					__( 'This will show EAN in vendor product form of the %s plugin.', 'ean-for-woocommerce' ),
					'<a target="_blank" href="https://wordpress.org/plugins/dc-woocommerce-multi-vendor/">' .
						__( 'MultiVendorX', 'ean-for-woocommerce' ) .
					'</a>'
				),
				'id'       => 'alg_wc_ean_mvx',
				'default'  => 'no',
			...
			array(
				...
				'desc_tip' => sprintf(
					/* Translators: %s: Plugin link. */
					__( 'This will fix the "Products" tab in the %s plugin (when the frontend search is enabled in our plugin).', 'ean-for-woocommerce' ),
					'<a target="_blank" href="https://wordpress.org/plugins/wc-vendors/">' .
						__( 'WC Vendors', 'ean-for-woocommerce' ) .
					'</a>'
				),
...
return new WPFactory_WC_EAN_Settings_Compatibility();
