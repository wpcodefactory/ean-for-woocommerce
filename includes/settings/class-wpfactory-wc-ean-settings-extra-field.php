...
if ( ! class_exists( 'WPFactory_WC_EAN_Settings_Extra_Field' ) ) :

class WPFactory_WC_EAN_Settings_Extra_Field extends WPFactory_WC_EAN_Settings_Section {
	 ...
	 * @since   4.0.0
	 *
	 * @todo    (dev) this is (almost) duplicated in `WPFactory_WC_EAN_Extra_Field::get_name()`
	 */
	function get_desc() {
