...
if ( ! class_exists( 'WPFactory_WC_EAN_Settings_Extra_Fields' ) ) :

class WPFactory_WC_EAN_Settings_Extra_Fields extends WPFactory_WC_EAN_Settings_Section {
...
return new WPFactory_WC_EAN_Settings_Extra_Fields();
