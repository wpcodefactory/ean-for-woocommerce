...
if ( ! class_exists( 'WPFactory_WC_EAN_Settings_Advanced' ) ) :

class WPFactory_WC_EAN_Settings_Advanced extends WPFactory_WC_EAN_Settings_Section {
...
return new WPFactory_WC_EAN_Settings_Advanced();
