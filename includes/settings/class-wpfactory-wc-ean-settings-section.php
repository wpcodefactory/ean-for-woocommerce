...
if ( ! class_exists( 'WPFactory_WC_EAN_Settings_Section' ) ) :

class WPFactory_WC_EAN_Settings_Section {
	...
	function __construct() {
		add_filter(
			'woocommerce_get_sections_' . 'wpfactory_wc_ean',
			array( $this, 'settings_section' )
		);
		add_filter(
			'woocommerce_get_settings_' . 'wpfactory_wc_ean' . '_' . $this->id,
