...
if ( ! class_exists( 'WPFactory_WC_EAN_Settings_Print' ) ) :

class WPFactory_WC_EAN_Settings_Print extends WPFactory_WC_EAN_Settings_Section {
	...
	function get_settings() {
		...
		$pdf_page_formats = require( 'wpfactory-wc-ean-pdf-page-formats.php' );
...
return new WPFactory_WC_EAN_Settings_Print();
